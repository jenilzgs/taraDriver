...
class CustomTitle extends StatelessWidget {
  ...
  const CustomTitle({super.key, required this.title,  this.isFiler = false, this.onTap, this.color});
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(title.tr, style: textSemiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: color??Theme.of(context).textTheme.bodyLarge!.color)),
          if(isFiler)
          GestureDetector(
            onTap: onTap,
