...
class CustomDatePicker extends StatefulWidget {
  ...
  const CustomDatePicker({super.key, required this.title,required this.text,required this.image, this.requiredField = false,this.selectDate});
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
      Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
        child: RichText(
          text: TextSpan(text: widget.title, style: textMedium.copyWith(color: Theme.of(context).textTheme.displayLarge!.color!),
            children: <TextSpan>[
