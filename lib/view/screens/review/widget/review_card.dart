               ...
               Padding(padding:  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                 child: Row(children: [
                   Container(decoration: BoxDecoration(
                     ...
                     child: ClipRRect(
                       borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                       child:  CustomImage(image: '${Get.find<ConfigController>().config!.imageBaseUrl!.profileImageCustomer!}/${review.givenUser!.profileImage??''}',
                         height: 30,width: 30,))),
                   Padding(padding:  const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                     child: Text('${review.givenUser!.firstName!} ${review.givenUser!.lastName!}',style: textMedium),
                   ),
                 ],),
               ),
                      ...
                      builder: (reviewController) {
                        return GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Icon(review.isSaved! ? Icons.bookmark : Icons.bookmark_border,
                              color: review.isSaved!? Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) :Theme.of(context).primaryColor : Theme.of(context).hintColor),
                          ),
                        );
                      }
                    ),
