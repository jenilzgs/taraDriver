    ...
    return GetBuilder<ReviewController>(
        builder: (reviewController) {
          return Padding(
            ...
            child: InkWell(
              onTap: ()=> reviewController.setReviewIndex(index),
              child: Container(width: MediaQuery.of(context).size.width/2.5,
                padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                decoration: BoxDecoration(
                  border: Border.all(width: .5, color: index == reviewController.reviewTypeIndex ? Theme.of(context).colorScheme.onSecondary: Theme.of(context).primaryColor),
                  color: index == reviewController.reviewTypeIndex? Theme.of(context).primaryColor : Theme.of(context).cardColor,
