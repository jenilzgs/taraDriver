                          ...
                          child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              const SizedBox(height: Dimensions.paddingSizeSignUp),
                                ...
                                CustomButton(buttonText: 'log_in'.tr,
                                  onPressed: (){
                              ...
                              if(Get.find<ConfigController>().config!.selfRegistration!)
                                ...
                                const SizedBox(height: Dimensions.paddingSizeDefault),
                                (Get.find<ConfigController>().config!.selfRegistration != null && Get.find<ConfigController>().config!.selfRegistration!)?
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                InkWell(onTap: ()=> Get.find<ConfigController>().sendMailOrCall("tel:${Get.find<ConfigController>().config?.businessContactPhone}", false),
