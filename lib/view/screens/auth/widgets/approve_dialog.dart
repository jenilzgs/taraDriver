...
class ApproveDialog extends StatelessWidget {
  ...
  const ApproveDialog({super.key, required this.icon, this.title, required this.description, required this.onYesPressed,
    });
      ...
      child: SizedBox(width: 500, child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center,children: [
            SizedBox(width: 60,child: CustomButton(buttonText:  'ok'.tr,
