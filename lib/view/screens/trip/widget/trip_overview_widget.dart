          ...
          builder: (tripController) {
            return Stack(children: [
                Column(children: [
                  ...
                  ReportsItemCard(title: 'total_review', qty: tripController.tripOverView?.totalReviews??0),
                ...
                Positioned(
                  child: Padding(
                    ...
                    child: Row(children: [
                      ...
                      SizedBox(width: Dimensions.dropDownWidth + 20,
                        child: DropdownButtonFormField2<String>(
                          ...
                          hint:  Text(tripController.selectedOverview.tr, style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
