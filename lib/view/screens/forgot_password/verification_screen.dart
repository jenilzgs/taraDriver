...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'otp_verification'.tr,showBackButton: true, regularAppbar: true,),
      body: Center(
        child: SingleChildScrollView(
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              AppConstants.isDemo ? Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall).copyWith(bottom: Dimensions.paddingSizeOver),
              ...
              SizedBox(width: 240,
                ...
                Padding(padding:  const EdgeInsets.only(top: Dimensions.paddingSizeExtraLarge,),
                  child: CustomButton(buttonText: 'send'.tr, radius: 50,
