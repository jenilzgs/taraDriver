          ...
          child: Row(children: [
            ...
            Stack(children: [
                ...
                ClipRRect(borderRadius : BorderRadius.circular(100),
                    child: CustomImage(width: 50,height: 50, image: customer?.profileImage != null?
                        '${Get.find<ConfigController>().config!.imageBaseUrl!.profileImageCustomer}/${customer?.profileImage??''}':''))]),
