...
class CustomMenuDrivingStatus extends StatelessWidget {
  final int index;
  final String icon;
  final int selectedIndex;
  const CustomMenuDrivingStatus({super.key, required this.index, required this.icon, required this.selectedIndex});
