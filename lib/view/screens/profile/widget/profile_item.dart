...
class ProfileItem extends StatelessWidget {
  ...
  final bool isStatus;
  final bool isLevel;
  const ProfileItem({super.key, required this.title, required this.value,  this.isStatus = false,  this.isLevel = false});
        ...
        children: [
          ...
          Container(decoration: BoxDecoration(
            ...
            child: Padding(
              ...
              child: Text('${'level'.tr} ${ Get.find<ProfileController>().profileInfo!.level != null? Get.find<ProfileController>().profileInfo!.level!.sequence! : 0}',
